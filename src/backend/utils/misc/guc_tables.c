...
struct config_bool ConfigureNamesBool[] =
{
...

	{
      {"btree_leaf_prefetch", PGC_USERSET, DEVELOPER_OPTIONS,
       gettext_noop("Enable lookahead prefetch for sibling leaf pages in B-Tree scans."),
       NULL,
       GUC_NOT_IN_SAMPLE
      },
      &btree_leaf_prefetch,
    ...
    },
	{
      {"btree_binsrch_linear", PGC_USERSET, DEVELOPER_OPTIONS,
       gettext_noop("Use linear search on tiny B-Tree leaf pages."),
       NULL,
       GUC_NOT_IN_SAMPLE
      },
...
struct config_int ConfigureNamesInt[] =
{
...

	{
      {"btree_binsrch_linear_threshold", PGC_USERSET, DEVELOPER_OPTIONS,
       gettext_noop("Max leaf items to use linear search instead of binary search."),
       NULL,
       GUC_NOT_IN_SAMPLE
      },
